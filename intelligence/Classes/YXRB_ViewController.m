...
#import "YXRB_ViewController.h"

@interface YXRB_ViewController ()

@end

@implementation YXRB_ViewController
...
-(void)saveData
{
    ...
    if (!self.Kmodel) {
        ...
        NSArray *arr = @[
                         ...
                         @{@"flag":@"1"},
                         @{@"mboObjectName":@"UDPRORUNLOGLINE"},
                         @{@"mboKey":@"UDPRORUNLOGLINEID"},
    ...
    else
    {
        NSArray *arr = @[
                         ...
                         @{@"flag":@"1"},
                         @{@"mboObjectName":@"UDPRORUNLOGLINE"},
                         @{@"mboKey":@"UDPRORUNLOGLINE"},
                         @{@"mboKeyValue":self.Kmodel.UDPRORUNLOGLINEID},
                         ];
