...
@interface StockViewControllers ()<UITableViewDataSource,UITableViewDelegate,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
{
...
@implementation StockViewControllers
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (!cell) {
        ...
        cell.stock = [self chooseType:indexPath.section];
    
    return cell;
}

-(StockModel *)chooseType:(NSInteger)type{
    StockModel *stock;
    if (stock == StockTypeNone) {
