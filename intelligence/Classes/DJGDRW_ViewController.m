...
@interface DJGDRW_ViewController ()

@end

@implementation DJGDRW_ViewController
...
-(void)saveData
{
    ...
    else
    {
        NSArray *arr = @[
                         ...
                         @{@"mboObjectName":@"UDWOACTIVITY"},
                         @{@"mboKey":@"WONUM"},
                         @{@"mboKeyValue":self.Kmodel.UDWOACTIVITYID},
                         ];
