...
@interface DJTSRB_ViewController ()

@end

@implementation DJTSRB_ViewController
...
-(void)saveData
{
    ...
    else
    {
        NSArray *arr = @[
                         ...
                         @{@"flag":@"1"},
                         @{@"mboObjectName":@"UDPRORUNLOGLINE2"},
                         @{@"mboKey":@"UDPRORUNLOGLINE2ID"},
                         @{@"mboKeyValue":self.Kmodel.UDPRORUNLOGLINE2ID},
                         ];
