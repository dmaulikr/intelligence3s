...
@interface GZRZHD_ViewController ()

@end

@implementation GZRZHD_ViewController
...
-(void)saveData
{
    ...
    else
    {
        NSArray *arr = @[
                         ...
                         @{@"mboObjectName":@"UDRUNLINER"},
                         @{@"mboKey":@"UDRUNLINERID"},
                         @{@"mboKeyValue":self.Kmodel.UDRUNLINERID},
                         ];
