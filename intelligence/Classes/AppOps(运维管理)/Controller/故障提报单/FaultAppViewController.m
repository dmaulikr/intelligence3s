...
@interface FaultAppViewController ()<UITableViewDataSource,UITableViewDelegate,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
{
...
@implementation FaultAppViewController
...
-(PaultAppModel *)chooseType:(NSInteger)type{
    PaultAppModel *stock;
    if (self.stcokType == StockTypeNone) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    vc.pault = [self chooseType:indexPath.section];
    vc.title = @"故障提报单详情";
