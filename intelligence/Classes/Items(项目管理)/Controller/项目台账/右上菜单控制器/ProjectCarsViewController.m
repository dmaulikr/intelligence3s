...
@interface ProjectCarsViewController ()<UITableViewDataSource,UITableViewDelegate,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
{
    NSInteger _number;
...
@implementation ProjectCarsViewController
    ...
    self.task = [HTTPSessionManager getWithUrl:@"/maximo/mobile/common/api" params:dataDic success:^(id response) {
        ...
        _arrayCount = _dataArray.count;
                ...
                for (NSDictionary *dic in array) {
                    ProjectCarsModel *stock = [ProjectCarsModel mj_objectWithKeyValues:dic];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.projectCars = [self modelTypeWithIndex:indexPath.section];
    return cell;
}

- (ProjectCarsModel *)modelTypeWithIndex:(NSInteger)index{
    ProjectCarsModel *model;
