...
@interface ZYSGDRW_ViewController ()

@end

@implementation ZYSGDRW_ViewController
...
-(void)saveData
{
    ...
    else
    {
        NSArray *arr = @[
                         ...
                         @{@"mboObjectName":@"WOACTIVITY"},
                         @{@"mboKey":@"WOACTIVITYID"},
                         @{@"mboKeyValue":self.Kmodel.WOACTIVITYID},
                         ];
