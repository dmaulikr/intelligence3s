...
@interface RunLogViewController ()<UITableViewDataSource,UITableViewDelegate,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
{
...
-(void)rightButtonPress{
    ...
    RunLogAddViewController * add = [[RunLogAddViewController alloc] init];
    add.title = @"新建运行记录";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.runlog = [self chooseType:indexPath.section];
    return cell;
}

-(RunlogModel *)chooseType:(NSInteger)type{
