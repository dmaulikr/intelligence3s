 ...
 *
 */
#define HUDNormal(msg) {MBProgressHUD *hud=[MBProgressHUD showHUDAddedTo:self.view animated:YES];\
...
#define WHUDNormal(msg) {MBProgressHUD *hud=[MBProgressHUD showHUDAddedTo:weakSelf.view animated:YES];\
hud.mode = MBProgressHUDModeText;\
hud.removeFromSuperViewOnHide = YES;\
hud.margin = 15;\
hud.minShowTime = 1;\
...
#define HUDNormals(msg) {MBProgressHUD *hud=[MBProgressHUD showHUDAddedTo:self animated:YES];\
hud.mode = MBProgressHUDModeText;\
hud.removeFromSuperViewOnHide = YES;\
hud.margin = 15;\
hud.minShowTime = 1;\
...
#define WHUDNormals(msg) {MBProgressHUD *hud=[MBProgressHUD showHUDAddedTo:weakSelf animated:YES];\
hud.mode = MBProgressHUDModeText;\
hud.removeFromSuperViewOnHide = YES;\
hud.margin = 15;\
hud.minShowTime = 1;\
...
#define WHUDJuHuaNoStop(msg)    {MBProgressHUD *hud=[MBProgressHUD showHUDAddedTo:weakSelf.view animated:YES];\
hud.detailsLabelText = msg;\
hud.animationType = MBProgressHUDAnimationFade;\
hud.detailsLabelFont = [UIFont boldSystemFontOfSize:15];\
hud.mode = MBProgressHUDModeIndeterminate;}
...
#define WHUDNoStop(msg)    {MBProgressHUD *hud=[MBProgressHUD showHUDAddedTo:weakSelf.view animated:YES];\
hud.detailsLabelText = msg;\
hud.animationType = MBProgressHUDAnimationFade;\
hud.detailsLabelFont = [UIFont boldSystemFontOfSize:15];\
hud.margin = 15;\
...
#define WHUDStop [MBProgressHUD hideAllHUDsForView:weakSelf.view animated:YES];
...
#define kGetCurrentTime(typeStr) [NSString getCurrentTimeWithType:typeStr]

/**
 *  HUD自动隐藏文字
 *
 */
#define kDictionaryToJson(dic) [DictionaryToJson dictionaryToJson:dic];
