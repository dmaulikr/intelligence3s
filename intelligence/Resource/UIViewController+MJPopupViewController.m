...
- (void)presentPopupView:(UIView*)popupView animationType:(MJPopupViewAnimation)animationType dismissed:(void(^)(void))dismissed
{
    ...
    [popupView setFrame:CGRectMake(popupViewFrame.origin.x, popupViewFrame.origin.y-100, popupViewFrame.size.width, popupViewFrame.size.height)];
    ...
    [overlayView setFrame:CGRectMake(overlayViewFrame.origin.x, overlayViewFrame.origin.y-120, overlayViewFrame.size.width, overlayViewFrame.size.height+120)];
