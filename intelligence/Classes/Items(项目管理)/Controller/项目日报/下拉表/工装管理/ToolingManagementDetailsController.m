...
@interface ToolingManagementDetailsController ()
{
...
@implementation ToolingManagementDetailsController
...
- (void)setToolingManagement:(ToolingManagementModel *)toolingManagement{
    ...
    if (toolingManagement.RUNLOGDATE.length > 0) {
        self.firstRow.contentLabel.text = toolingManagement.RUNLOGDATE;
        self.firstRow.contentLabel.textColor = [UIColor blackColor];
    }
    
    if (toolingManagement.TYPE.length > 0) {
        self.secondRow.contentLabel.text = toolingManagement.TYPE;
        self.secondRow.contentLabel.textColor = [UIColor blackColor];
    }
    
    if (toolingManagement.NUMBER1.length > 0) {
        self.thirdRow.contentText.text = toolingManagement.NUMBER1;
        self.thirdRow.placeholderLabel.text = @"";
    }
    
    if (toolingManagement.NUMBER3.length > 0) {
        self.forthRow.contentText.text = toolingManagement.NUMBER3;
        self.forthRow.placeholderLabel.text = @"";
    }
    
    if (toolingManagement.WINDSPEED.length > 0) {
        self.fifthRow.contentText.text = toolingManagement.WINDSPEED;
        self.fifthRow.placeholderLabel.text = @"";
    }
    
    if (toolingManagement.NUMBER4.length > 0) {
        self.sixthRow.contentText.text = toolingManagement.NUMBER4;
